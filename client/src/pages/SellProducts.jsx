...
const SellProducts = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("email", currentUser.email); // Add seller's email
      formData.append("status", "On Sale");
      formData.append("seller", currentUser.name); // Add seller's name
      formData.append("image", form.image); // Add image file
      ...
      toast.error(error.response?.data?.message || "Error listing product");
    }
  };
