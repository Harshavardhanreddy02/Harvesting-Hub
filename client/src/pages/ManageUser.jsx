...
const ManageUser = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Fix: use newUser instead of userData for adding new users
      // and formData for editing existing users
      const userData = isEditModalOpen ? formData : newUser;
      ...
      formattedUserData.role = formattedUserData.role.toLowerCase();
    ...
    <div className="flex items-start gap-12">
      ...
      <div className='manage-user__outer-div'>
        ...
        <div className='manage-user__button-container'>
          ...
          <Button onClick={exportToCSV} className="bg-green-500">
            Export to CSV
          </Button>
        </div>
