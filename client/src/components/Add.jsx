...
import Sidebar from "./Sidebar"; // Keep this as is since we're updating Sidebar to use default export
...
export const Add = () => {
  ...
  const onSubmitHandler = async (e) => {
    e.preventDefault();
    const url = `${import.meta.env.VITE_BACKEND_URL}/api/product/add`;
